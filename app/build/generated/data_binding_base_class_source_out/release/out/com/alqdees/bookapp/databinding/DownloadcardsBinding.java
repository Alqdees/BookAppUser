...
public final class DownloadcardsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static DownloadcardsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static DownloadcardsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.downloadcards, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DownloadcardsBinding bind(@NonNull View rootView) {
