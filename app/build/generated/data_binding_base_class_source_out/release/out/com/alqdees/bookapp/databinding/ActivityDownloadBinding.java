...
public final class ActivityDownloadBinding implements ViewBinding {
  ...
  private ActivityDownloadBinding(@NonNull RelativeLayout rootView, @NonNull RelativeLayout appbar,
  ...
  public static ActivityDownloadBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityDownloadBinding((RelativeLayout) rootView, appbar, recycler);
    }
