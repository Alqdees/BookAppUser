package com.alqdees.bookapp.Constants;
...
//    public static void downloadBook(Context context,String bookId,String bookTitle,String bookUrl) throws IOException {
//
...
//    }
    ...
    private static void saveDownloadBook(
            Context context, ProgressDialog progressDialog, byte[] bytes, String name, String bookId)
    {
        try{
...
//            ref.child(Objects.requireNonNull(firebaseAuth.getUid())).child("Favorites").child(bookId).setValue(hashMap)
